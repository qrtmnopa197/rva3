...
Run mf analysis with previous outcome - instead of previous prob. rating - from the current cue (exponential decay priming)
```{r}
...
Also terribel diagnostics. What's wrong with the previous outcome models?