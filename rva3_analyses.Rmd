...
Create a table of parameter estimates from the final model (this table is included in the supplement).
```{r}
...
mu_table[c(1,2,12),2:4] <- sigmoid(mu_table[c(1,2,12),2:4]) # Transform learning and forgetting rate to original scale
mu_table[c(6,7,8,10,11),2:4] <- mu_table[c(6,7,8,10,11),2:4]*200 # Multiply effects in units of points by 100
...
write.csv(mu_table,"~/Documents/manuscripts/rva/figures_tables/param_tabs/params_tab_s3.csv")
```
