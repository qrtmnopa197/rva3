...
// Also allows probability ratings to prime future valence ratings with a separate exponential decay process.
...
parameters {
  ...
  // Decay rate for effects of probability ratings on valence
  real kappa_mu;
...
transformed parameters {
  ...
  {//anonymous scope start
    ...
    vector[n_s] kappa = inv_logit(kappa_mu + kappa_sigma*kappa_z);
